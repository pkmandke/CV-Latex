...
\section{Education}
\cventry{Aug'19 -- May'21}{}{\fontsize{11pt}{12pt}\selectfont Virginia Tech}{Blacksburg, VA}{\hspace*{-2.9 mm} Master's in Computer Engineering, GPA: 4.0/4.0}{\normalsize Coursework: Deep Learning, Adv Parallel Computing (on-going), Information Storage \& Retrieval}
...
\cventry{Aug'15 -- May'19}{}{\fontsize{11pt}{12pt}\selectfont Govt. College of Engineering, Pune (COEP)}{Pune, India}{\hspace*{-2.5 mm} B.Tech Electronics \& Telecommunication, \small GPA: 9.11/10, Class Rank: 6/81}{Minor in Computer Engineering}
...
\vspace{-2.2em}
\section{Experience}
\cventry{Jun'19 -- Jul'19 }{}{\fontsize{11pt}{12pt}\selectfont Flytbase, Inc.}{Pune, India}{\hspace{-0.2em}HackerSpace Intern - Deep Learning }{
}
\vspace{-1.0em}
\begin{itemize} \normalsize{
...
\cventry{Jun'17 -- Jul'18}{}{\fontsize{11pt}{11pt}\selectfont Siemens, Ltd.}{Mumbai, India}{\hspace{-0.2em}Siemens Student Progam Intern }{
}
\vspace{-1.0em}
\begin{itemize} \normalsize{
...
\cventry{}{}{\normalsize Clustering Large Scale Text Corpora for Efficient Information Retrieval}{Aug'19 - Dec'19 \vspace{-1.0em}}{}{
% Detailed achievements:%
\begin{itemize} \normalsize{
    \item[\textbullet] Vectorized 2 large text corpora with ~33k and ~1M documents using Doc2Vec - a neural network based algorithm.
    \item[\textbullet] Implemented K-Means clustering, Agglomerative clustering, DBSCAN and Birch using the document vectors.
    \item[\textbullet] Benchmarked using the Calinski-Harasbasz Index, the Davies-Bouldin and the Silhoutte Score.
    \item[\textbullet] Skills/Tools: Python - sklearn, gensim, nltk, Docker, Kubernetes. Code: [\href{https://github.com/pkmandke/cs5604-tml-clustering}{\textcolor{blue}{\underline{github}}}].}
\end{itemize}
}

\cventry{}{}{\normalsize Lempel-Ziv-Welch Text File Compression - A python package}{Apr'18 - Sep'18}{}{
\vspace{-1.2em}
\begin{itemize} \normalsize{
    \item[\textbullet] A UTF-8 file compression package with average compression ratio (C.R.) of 0.5 and O(logn) phrase look-up complexity using the Trie data structure. Link to repository: [\href{https://github.com/pytholic97/LZW-Text-File-Compression}{\textcolor{blue}{\underline{github}}}]
...
\end{itemize}}
\begin{comment}
\cventry{}{}{\normalsize Human Posture Recognition using Artificial Neural Networks}{Feb'18 - May'18 \vspace{-1.0em}}{}{
% Detailed achievements:%
\begin{itemize} \normalsize{
...
\cventry{}{}{\normalsize Sparse View CT Image Reconstruction using Deep CNNs}{Sep'19 - Present \vspace{-1.0em}}{}{
% Detailed achievements:%
%\vspace{-0.5em}
\begin{itemize}\normalsize{
    \item[\textbullet] Designing CNN architecture for sparse view CT reconstruction based on transpose convolutions and skip connections.
\item[\textbullet] Generated synthetic CT dataset with varying sparsity to train CNN models using SSIM and RMSE.
\item[\textbullet] Skills: Python, PyTorch, MATLAB.}
\end{itemize}
}
...
\begin{itemize}
    ...
    [\href{https://ieeexplore.ieee.org/document/8692143}{\textcolor{blue}{\underline{IEEExplore}}}]
    \smallskip
\end{itemize}}
