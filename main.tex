...
\section{Education}
\cventry{August 2019 -- May 2021}{}{\large Virginia Tech}{Blacksburg, VA}{\hspace*{-2.9 mm} Master's in Computer Engineering (Software \& Machine Intelligence)}{\normalsize Coursework: \href{https://gist.github.com/pkmandke/672ff9333eaf449d69df28d9a37eecbb}{\textcolor{blue}{\underline{CS 6524: Deep Learning}}}, CS 5604: Information Storage \& Retrieval}
...
\item[\textbullet] Skills: Python, Tensorflow, OpenCV, OpenCL. Details: \href{https://gist.github.com/pkmandke/34a811a7b0bc20a9fa62968a89a902e8}{\textcolor{blue}{\underline{here}}}}.
\end{itemize}
}
% \vspace{1.0em}
...
\begin{itemize} \normalsize{
    ...
    \item[\textbullet] Used 2 sensor nodes(thigh and chest) to collect 44,800 samples and train \& deploy the neural network model using pure numpy. Accuracy: 97.5\%. Code: \href{https://bit.ly/2Ovel6a}{\textcolor{blue}{\underline{https://bit.ly/2Ovel6a}}}
    \item[\textbullet] Skills/Tools: Python, C++, Raspberry-Pi, ESP8266. Dataset: \href{https://github.com/pkmandke/Human-Posture-Dataset}{\textcolor{blue}{\underline{here}}}.}
\end{itemize}
}
...
\vspace{-1.2em}
\begin{itemize} \normalsize{
    \item[\textbullet] A UTF-8 file compression package with average compression ratio (C.R.) of 0.5 and O(logn) phrase look-up complexity using the Trie data structure. Link to repository: \href{https://bit.ly/2vhGPHy}{\textcolor{blue}{\underline{https://bit.ly/2vhGPHy}}}
...
\section{Skills}
\vspace{-0.5em}
\textbf{\large Primary:} C, Python, Tensorflow, Numpy, Git, Linux. \\
\textbf{\large Secondary:} C++, ROS, PyTorch, MATLAB, LaTEX, Verilog, HTML-CSS.
...
\begin{itemize}
    ...
    \item[\textbullet] Gold Medalist Soft Computing MOOC by IIT-Kharagpur (NPTEL). Certificate: \href{https://drive.google.com/file/d/1dKUy8gFmk8qgwBTK5Nt_A5F2VZkxPQ9Y/view?usp=sharing}{\underline{\textcolor{blue}{here}}}.
\end{itemize}
